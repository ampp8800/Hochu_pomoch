...
public class ProfileRepository {
    ...
    public static void newFrendsList() {
        ...
        frendsList.add(new FriendListItem("Даша Стрелкова", "https://sun1-95.userapi.com/s/v1/ig1/aHdIz7kOAHnmwllzx5ggHJwQlsvjRvlVpyiJ3DYPWTwdDsBdXugRqTX8hIqKYRZp_7Tp0KXz.jpg?size=100x100&quality=96&crop=0,4,769,769&ava=1.png"));
    }
